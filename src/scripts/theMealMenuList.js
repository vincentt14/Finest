    ...
    theMealMenuLists.innerHTML += `
      <article class="post-item" tabindex="3">
        ...
        <div class="post-item__content">
          <p class="post-item__rating" tabindex="3">Category : <span class="post-item__rating__value">${meal.strCategory}</span></p>
          <h1 class="post-item__title" tabindex="3">${meal.strMeal}</h1>
          <p class="post-item__description" tabindex="3">${meal.strInstructions}</p>
        </div>
      </article>`;
  });
};
