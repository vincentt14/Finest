...
const itActsAsFavoriteRestaurantModel = (favoriteRestaurant) => {
  ...
  it('should be able to search for restaurants', async () => {
    favoriteRestaurant.putRestaurant({ id: 1, title: 'restp a' });
    favoriteRestaurant.putRestaurant({ id: 2, title: 'restp b' });
    favoriteRestaurant.putRestaurant({ id: 3, title: 'restp abc' });
    favoriteRestaurant.putRestaurant({ id: 4, title: 'ini mah restp abcd' });

    expect(await favoriteRestaurant.searchRestaurants('restp a')).toEqual([
      { id: 1, title: 'restp a' },
      { id: 3, title: 'restp abc' },
      { id: 4, title: 'ini mah restp abcd' },
    ]);
  });
};
